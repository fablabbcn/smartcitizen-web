...
$templateCache.put('app/components/store/store.html','<md-button class="md-flat" ng-class="(isLoggedin) ? \'navbar_highlight_button\' : \'padding14\'" ng-href="https://www.seeedstudio.com/smartcitizen" analytics-on="click" analytics-event="Kit Purchase" analytics-action="view">Get your Kit</md-button>');
