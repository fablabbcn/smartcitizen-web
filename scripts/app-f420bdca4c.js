...
$templateCache.put('app/components/interstitial/interstitial.html','<divs></divs>');
...
$templateCache.put('app/components/layout/layout.html','<div class="navbar_container"><md-toolbar layout="row" layout-align="space-between center" class="stickNav"><a ui-sref="landing" class="logo_link"><md-tooltip md-direction="bottom"></md-tooltip><md-icon class="m-10 ml-15 logo_icon" md-svg-src="./assets/images/LogotipoSmartCitizen.svg" alt="Insert Drive Icon"></md-icon></a><search flex=""></search><section hide-xs="" layout="row" layout-align="{{vm.navRightLayout}}"><div ng-show="vm.isShown" hide-xs="" hide-sm="" store="" logged="vm.isLoggedin" class="md-flat get"></div><div ng-show="vm.isShown && !vm.isLoggedin" hide-xs="" login="" class="navbar_login_button"></div><md-menu ng-show="vm.isShown && vm.isLoggedin"><md-button class="btn-small no-hover-effect" ng-click="$mdMenu.open($event)" layout="column" layout-align="center center"><md-tooltip md-direction="bottom" class="font-kanit">Your profile</md-tooltip><img class="circular-img-crop navbar_avatar_icon image-outline" ng-src="{{ vm.currentUser.profile_picture || \'./assets/images/avatar.svg\' }}"></md-button><md-menu-content ng-mouseleave="$mdMenu.close()"><md-menu-item><md-button href="{{vm.user_url}}" class="font-kanit">Hi, {{vm.currentUser.username}}!</md-button></md-menu-item><md-menu-item><md-button href="{{vm.user_url}}" class="font-kanit">My profile</md-button></md-menu-item><md-menu-item><md-button ng-click="vm.logout()" class="font-kanit">Log out</md-button></md-menu-item></md-menu-content></md-menu></section><md-button ng-click="toggleRight()" layout="column" layout-align="center center"><img class="" ng-src="{{\'./assets/images/menu2.svg\' }}"></md-button></md-toolbar></div><section layout="row" flex=""><md-sidenav class="md-sidenav-right" md-component-id="right" md-whiteframe="3"><md-toolbar layout="row" layout-align="end center"><md-button ng-click="toggleRight()" layout="column" layout-align="center center"><img class="" ng-src="{{\'./assets/images/menu2.svg\' }}"></md-button></md-toolbar><md-content><md-menu-item ng-show="vm.isShown && !vm.isLoggedin" login="" class="font-kanit"></md-menu-item><md-menu-item ng-show="vm.isShown && !vm.isLoggedin" signup="" class="font-kanit"></md-menu-item><md-menu-item ng-show="vm.isLoggedin"><md-button href="{{vm.user_url}}" class="font-kanit">Profile</md-button></md-menu-item><md-menu-item ng-show="vm.isLoggedin"><md-button ng-click="vm.logout()" class="font-kanit">Log out</md-button></md-menu-item><md-divider></md-divider><md-menu-item><md-button target="_blank" href="{{vm.seeed_url}}" class="font-kanit">Get your kit</md-button></md-menu-item><md-divider></md-divider><md-menu-item ng-repeat="item in vm.dropdownOptionsCommunity"><md-button target="_blank" href="{{item.href}}" class="font-kanit">{{item.text}}</md-button></md-menu-item></md-content></md-sidenav></section><div ui-view=""></div><footer class="footer" ng-if="!vm.overlayLayout" ng-include="\'app/components/footer/footer.html\'" layout="row" layout-align="center center"></footer>');
$templateCache.put('app/components/login/login.html','<md-button class="md-flat font-kanit" href="{{vm.login_url}}" angular-on="click" angular-event="Login" angular-action="click">Log In</md-button>');
...
$templateCache.put('app/components/map/mapFilterModal.html','<md-dialog class="filters"><md-toolbar><div class="md-toolbar-tools"><h2 class="font-kanit uppercase weight-800">Filters</h2><span flex=""></span><md-button class="md-icon-button" ng-click="vm.cancel()"><md-icon md-svg-icon="./assets/images/close_icon_blue.svg" aria-label="Close dialog"></md-icon></md-button></div></md-toolbar><md-dialog-content><div class="md-dialog-content max-width-500px"><md-content layout-padding=""><h4 class="font-kanit m-0">Filter kits by online/offline status</h4><p class="font-kanit m-0">Online Kits have published data online at least during the past 60 minutes</p><div ng-repeat="filter in vm.status" class="mt-0"><md-checkbox ng-click="vm.toggle(vm.status)" ng-model="vm.checks[filter]"><span class="filter font-kanit uppercase">{{filter}}</span></md-checkbox></div></md-content><md-content style="margin-top: 10px;" layout-padding=""><h4 class="font-kanit m-0">Or by indoor/outdoor data</h4><div ng-repeat="filter in vm.location" class="mt-0"><md-checkbox ng-click="vm.toggle(vm.location)" ng-model="vm.checks[filter]"><span class="filter font-kanit uppercase">{{filter}}</span></md-checkbox></div></md-content></div><md-button class="md-warn btn-full font-kanit uppercase weight-800 button-modal font-16" ng-click="vm.clear()">Clear filters</md-button><md-button class="btn-blue btn-full font-kanit uppercase weight-800 button-modal font-16" ng-click="vm.answer()">Apply</md-button></md-dialog-content></md-dialog>');
$templateCache.put('app/components/map/mapTagModal.html','<md-dialog><md-toolbar><div class="md-toolbar-tools"><h2 class="font-kanit uppercase weight-800">Tags</h2><span flex=""></span><md-button class="md-icon-button" ng-click="vm.cancel()"><md-icon md-svg-icon="./assets/images/close_icon_blue.svg" aria-label="Close dialog"></md-icon></md-button></div></md-toolbar><md-dialog-content><div class="md-dialog-content max-width-500px min-height-80 font-kanit"><p class="hide-xs">Select from the list to show the kits containing ALL these tags.</p><md-input-container md-no-float="" class="md-block"><input type="text" ng-model="tagSearch" placeholder="Search for tags.."></md-input-container><md-content layout-padding="" style="height: calc(80vh - 450px);"><div class="mt-0 mb-0" ng-repeat="tag in vm.tags | filter:{name: tagSearch}"><md-checkbox ng-model="vm.checks[tag.name]"><span class="tag mt-5">{{ tag.name }}</span></md-checkbox></div></md-content></div><md-button class="md-warn btn-full font-kanit uppercase weight-800" ng-click="vm.clear()">Clear selection</md-button><md-button class="btn-blue btn-full font-kanit uppercase weight-800" ng-click="vm.answer()">Apply</md-button></md-dialog-content></md-dialog>');
$templateCache.put('app/components/myProfile/Kits.html','<div class="profile_content" layout="column" layout-gt-sm="row"><div class="profile_sidebar pt-80" layout-align="start" layout-align-xs="start center" layout="column"><p class="profile_sidebar_title text-center">FILTER KITS BY</p><div class="" layout="row" layout-align="center center" layout-gt-sm="column"><md-button ng-click="vm.filterDevices(\'all\')" class="profile_sidebar_button">ALL</md-button><md-button ng-click="vm.filterDevices(\'online\')" class="profile_sidebar_button">ONLINE</md-button><md-button ng-click="vm.filterDevices(\'offline\')" class="profile_sidebar_button">OFFLINE</md-button></div></div><div class="pt-80 px-20 mb-30" flex=""><div class="profile_content_main_top"><md-button class="btn-round-new btn-cyan" ng-click="addDeviceSelector()">ADD A NEW KIT</md-button><span class="float-right">{{ vm.filteredDevices.length || 0 }} kits filtering by {{ vm.deviceStatus.toUpperCase() || \'ALL\' }}</span></div><kit-list actions="{downloadData: vm.downloadData}" devices="vm.filteredDevices"></kit-list><div class="kitList kitList_borderBottom" ng-show="!vm.devices.length"><div class="kitList_container"><div class="kitList_noKits"><span>There are not kits yet</span></div></div></div></div></div>');
...
$templateCache.put('app/components/myProfile/myProfile.html','');
...
$templateCache.put('app/components/store/store.html','<md-button class="md-flat font-kanit navbar_highlight_button" ng-href="{{vm.seeed}}" ng-attr-target="_blank"><md-tooltip md-direction="bottom" class="font-kanit">Get your kit on Seeed studio</md-tooltip>Get your Kit</md-button>');
...
$templateCache.put('app/components/tags/tags.html','<section class="kitTags__section" ng-if="tagsCtl.selectedTags.length > 0" change-content-margin=""><div class="shadow"></div><div class="over_map"><div class="kit_fixed kitTags__container bg-white"><div class="kitTags__textContainer" layout-xs="column"><div class="kitTags__textElement"><h1><span ng-repeat="tag in tagsCtl.selectedTags" class="font-mono weight-700">#{{tag}}</span></h1><h2>{{tagsCtl.markers.length}} kit{{tagsCtl.markers.length > 1 ? \'s are\' : \' is\'}} on <em ng-repeat="tag in tagsCtl.selectedTags">#{{tag}}</em> and {{tagsCtl.percActive}}% are active today.</h2><p ng-repeat="tag in tagsCtl.selectedTags"></p></div><div class="kitTags__textElement"><h3 class="md-title font-kanit weight-700">About #Tags<p class="sg-paragraph2">These tags are contributed by the community and show the variety applications of the Smart Citizen Project. You can use tags to organize and filter devices. If you need a tag, and you can\'t find one that works for you, you can request the creation of new tags in the forum.</p><br><a style="text-decoration: none" href="https://forum.smartcitizen.me/c/general/" class="md-button btn-black-outline btn-round-new">SUGGEST NEW TAGS</a></h3></div></div></div></div><div class="kitTags__listContainer kit_fixed"><md-progress-circular ng-show="!tagsCtl.devices || tagsCtl.devices.length <= 0" class="md-hue-3 chart_spinner" md-mode="indeterminate"></md-progress-circular><section class="kit_owner_kits" ng-if="tagsCtl.devices.length > 0"><kit-list devices="tagsCtl.devices"></kit-list></section></div></section>');
