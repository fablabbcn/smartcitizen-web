    ...
    function chart(sensor) { 
      ...
      function updateChartMain(data, options) {
        ...
        */
        ...
        function mousemove() {
          ...
          popupText.select('.popup_value_main').text(parseValue(d.count) + options.unit);
      ...
      function updateChartCompare(data, options) {
        ...
        */
        ...
        text.append('tspan')
          .attr('class', 'popup_value_compare')
          .attr('x', 0)
        ...
        function mousemove() {
          ...
          var popupText = popup.select('text');
          popupText.select('.popup_value_compare').text(parseValue(dMain.count) + unitMain);
          popupText.select('.popup_value_main').text(parseValue(d.count) + options.unit);
          popupText.select('.popup_date').text(parseTime(d.date));
